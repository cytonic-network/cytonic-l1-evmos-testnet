...
NODE_C_KEY=$(docker compose run --no-deps --rm node-c keys add validator-c --keyring-backend test --home $CHAIN_HOME/node-c --output json)
NODE_D_KEY=$(docker compose run --no-deps --rm node-d keys add validator-d --keyring-backend test --home $CHAIN_HOME/node-d --output json)
...
docker compose run --no-deps --rm node-a add-genesis-account $NODE_A_ADDRESS 10000000000000000000000000000aevmos --home $CHAIN_HOME/node-a
docker compose run --no-deps --rm node-a add-genesis-account $NODE_B_ADDRESS 10000000000000000000000000000aevmos --home $CHAIN_HOME/node-a
docker compose run --no-deps --rm node-a add-genesis-account $NODE_C_ADDRESS 10000000000000000000000000000aevmos --home $CHAIN_HOME/node-a
docker compose run --no-deps --rm node-a add-genesis-account $NODE_D_ADDRESS 10000000000000000000000000000aevmos --home $CHAIN_HOME/node-a
